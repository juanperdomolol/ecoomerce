...
<title>Kingstore - Plantilla bootstrap</title>
<!-- Bootstrap core CSS -->
<!--
...
<body>
 ...
 <img class="card-img-top img-fluid" id="product_image"
 src="" alt="">
<div class="card-body">
 ...
 aria-expanded="false"
 aria-controls="#collapseComment"> Dejar un comentario</a>
 </p>
...
<div class="card card-body">
 ...
 <label for="comment">Comentariot</label>
...
<div class="form-group">
 ...
 <div>
 <span class="rateit" id="rating"
 data-rateit-step="0.1"
 data-rateit-min="0"
 data-rateit-max="5"></span>
 <span id="rating_value"></span>
 </div>
 </div>
