...
function getProductById(product_id){
	...
	function getReviews(product_id){
	 ...
	 review += '<hr>';
	 review += '<p>' + comment + '</p>';
	 review += '<small class="text-muted">Posted by ';
	 review += username + ' on ' + created_at_text + '</small>';
	...
	function addReview(product_id){
	 ...
	 'data':JSON.stringify({
		 ...
		 at += '<button type="button" class="close"';
		 at += ' data-dismiss="alert" aria-label="Close">';
